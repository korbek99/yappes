...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/GoogleMaps/Base/Frameworks/GoogleMapsBase.xcframework" "" "false" "ios-arm64_x86_64-simulator/GoogleMapsBase.framework" "ios-arm64/GoogleMapsBase.framework"
  install_xcframework "${PODS_ROOT}/GoogleMaps/Maps/Frameworks/GoogleMaps.xcframework" "" "false" "ios-arm64_x86_64-simulator/GoogleMaps.framework" "ios-arm64/GoogleMaps.framework"
  install_xcframework "${PODS_ROOT}/GoogleMaps/Maps/Frameworks/GoogleMapsCore.xcframework" "" "false" "ios-arm64_x86_64-simulator/GoogleMapsCore.framework" "ios-arm64/GoogleMapsCore.framework"
fi
